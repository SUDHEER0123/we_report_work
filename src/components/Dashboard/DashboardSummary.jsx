            ...
            <div className="w-full flex flex-col bg-[#FFFFFF80] rounded-md  shadow-md items-center">
              <div className="w-full flex flex-col gap-10 pb-10 pt-8 pl-10">
                ...
                <ol>
                  ...
                  <ul className="list-disc space-x-0 pl-10 px-4">
                    <li className="text-[18px] font-normal leading-[23.44px] text-black">
                      Email communications included a project update, dinner
                      plans, a travel itinerary, a task assignment, and a
                      newsletter with industry updates and company news.
                    </li>
                  </ul>
                </ol>
                ...
                <ol>
                  ...
                  <ul className="list-disc space-x-0 pl-10 px-4">
                    <li className="text-[18px] font-normal leading-[23.44px] text-black">
                      You had a productive team meeting from 2:00 PM to 3:00 PM,
                      where you discussed project status and goals.
                    </li>
                    <li className="text-[18px] font-normal leading-[23.44px] text-black">
                      You planned dinner with friends tomorrow at 7:00 PM
                    </li>
                  </ul>
                </ol>
